...
import 'package:test123/group2/question2S.dart';

import '../groups.dart';

class oneS extends StatefulWidget {
  @override
  _oneSState createState() => _oneSState();
}
          ...
          home: Scaffold(
            ...
            body: Column(
              children: [
                ...
                Center(
                  child: Text(
                    '(1) Who has scored the most Premier League hat-tricks(three goals in a game)?',
