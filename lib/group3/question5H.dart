...
class fiveH extends StatefulWidget {
  late int c;

  fiveH({required this.c});

  @override
  _fiveHState createState() => _fiveHState();
}

class _fiveHState extends State<fiveH> {
  int selectedRadio = -1;
        ...
        home: Scaffold(
          ...
          body: Column(
            children: [
              ...
              Center(
                child: Text(
                  '(5) Before independence, what was Bangladesh called?',
